...
class TournoiController extends BaseController
{
    ...
    public function tournoi(ManagerRegistry $doctrine,Request $request): Response
    {
        ...
        return $this->renderForm('tournoi/tournoi.html.twig',['tournois'=>$tournois]);
    ...
    {
        $tournois = $doctrine->getRepository(Tournoi::class)->findAll();
        $notification = (new Notification('Voter Tournoi'))
            ->importance(Notification::IMPORTANCE_HIGH)
            ->subject('a ete refuser');
        $notification->content('dsqfsqfqsfqsfd');
        return $this->renderForm('tournoi/mytournoi.html.twig',['tournois'=>$tournois, 'notification' => $notification]);

    }
    public function notif(ManagerRegistry $doctrine,Request $request): Response
    {
        $tournois = $doctrine->getRepository(Tournoi::class)->findAll();
        $notification = (new Notification('Voter Tournoi'))
            ->importance(Notification::IMPORTANCE_HIGH)
            ->subject('a ete refuser');
        $notification->content('dsqfsqfqsfqsfd');
        return $this->renderForm('base.html.twig',['tournois'=>$tournois, 'notification' => $notification]);
