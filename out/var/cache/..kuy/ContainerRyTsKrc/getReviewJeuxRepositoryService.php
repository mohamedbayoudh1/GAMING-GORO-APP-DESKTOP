 ...
 */
class getReviewJeuxRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ReviewJeuxRepository' shared autowired service.
     *
     * @return \App\Repository\ReviewJeuxRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReviewJeuxRepository.php';

        return $container->privates['App\\Repository\\ReviewJeuxRepository'] = new \App\Repository\ReviewJeuxRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
