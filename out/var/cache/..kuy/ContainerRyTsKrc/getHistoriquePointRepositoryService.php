 ...
 */
class getHistoriquePointRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistoriquePointRepository' shared autowired service.
     *
     * @return \App\Repository\HistoriquePointRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistoriquePointRepository.php';

        return $container->privates['App\\Repository\\HistoriquePointRepository'] = new \App\Repository\HistoriquePointRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
