...
class getMembreGroupeRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MembreGroupeRepository.php';

        return $container->privates['App\\Repository\\MembreGroupeRepository'] = new \App\Repository\MembreGroupeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
