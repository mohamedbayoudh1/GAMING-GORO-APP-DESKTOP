...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AddCourseType' => ['privates', 'App\\Form\\AddCourseType', 'getAddCourseTypeService', true],
            'App\\Form\\CategorieType' => ['privates', 'App\\Form\\CategorieType', 'getCategorieTypeService', true],
            'App\\Form\\ClassementType' => ['privates', 'App\\Form\\ClassementType', 'getClassementTypeService', true],
            'App\\Form\\CoachPlanningType' => ['privates', 'App\\Form\\CoachPlanningType', 'getCoachPlanningTypeService', true],
            'App\\Form\\CoachType' => ['privates', 'App\\Form\\CoachType', 'getCoachTypeService', true],
            'App\\Form\\CommentaireNewsType' => ['privates', 'App\\Form\\CommentaireNewsType', 'getCommentaireNewsTypeService', true],
            'App\\Form\\GamerType' => ['privates', 'App\\Form\\GamerType', 'getGamerTypeService', true],
            'App\\Form\\GroupeType' => ['privates', 'App\\Form\\GroupeType', 'getGroupeTypeService', true],
            'App\\Form\\JeuxType' => ['privates', 'App\\Form\\JeuxType', 'getJeuxTypeService', true],
            'App\\Form\\JeuxType2' => ['privates', 'App\\Form\\JeuxType2', 'getJeuxType2Service', true],
            ...
            'App\\Form\\NewsType2' => ['privates', 'App\\Form\\NewsType2', 'getNewsType2Service', true],
            ...
            'App\\Form\\RechargeType' => ['privates', 'App\\Form\\RechargeType', 'getRechargeTypeService', true],
            'App\\Form\\ReviewJeuxType' => ['privates', 'App\\Form\\ReviewJeuxType', 'getReviewJeuxTypeService', true],
            'App\\Form\\SearchCourseType' => ['privates', 'App\\Form\\SearchCourseType', 'getSearchCourseTypeService', true],
            'App\\Form\\Team2Type' => ['privates', 'App\\Form\\Team2Type', 'getTeam2TypeService', true],
            'App\\Form\\Team3Type' => ['privates', 'App\\Form\\Team3Type', 'getTeam3TypeService', true],
            'App\\Form\\TeamType' => ['privates', 'App\\Form\\TeamType', 'getTeamTypeService', true],
            'App\\Form\\Tournoi2Type' => ['privates', 'App\\Form\\Tournoi2Type', 'getTournoi2TypeService', true],
            'App\\Form\\TournoiType' => ['privates', 'App\\Form\\TournoiType', 'getTournoiTypeService', true],
            'App\\Form\\UpdateCourseType' => ['privates', 'App\\Form\\UpdateCourseType', 'getUpdateCourseTypeService', true],
            'App\\Form\\UserOnlineCoachingType' => ['privates', 'App\\Form\\UserOnlineCoachingType', 'getUserOnlineCoachingTypeService', true],
            ...
            'App\\Form\\AddCourseType' => '?',
            'App\\Form\\CategorieType' => '?',
            'App\\Form\\ClassementType' => '?',
            'App\\Form\\CoachPlanningType' => '?',
            'App\\Form\\CoachType' => '?',
            'App\\Form\\CommentaireNewsType' => '?',
            'App\\Form\\GamerType' => '?',
            'App\\Form\\GroupeType' => '?',
            'App\\Form\\JeuxType' => '?',
            'App\\Form\\JeuxType2' => '?',
            ...
            'App\\Form\\RechargeType' => '?',
            'App\\Form\\ReviewJeuxType' => '?',
            'App\\Form\\SearchCourseType' => '?',
            'App\\Form\\Team2Type' => '?',
            'App\\Form\\Team3Type' => '?',
            'App\\Form\\TeamType' => '?',
            'App\\Form\\Tournoi2Type' => '?',
            'App\\Form\\TournoiType' => '?',
            'App\\Form\\UpdateCourseType' => '?',
            'App\\Form\\UserOnlineCoachingType' => '?',
