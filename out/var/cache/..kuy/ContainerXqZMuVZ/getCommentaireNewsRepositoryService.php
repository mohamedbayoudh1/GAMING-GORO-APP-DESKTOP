 ...
 */
class getCommentaireNewsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommentaireNewsRepository' shared autowired service.
     *
     * @return \App\Repository\CommentaireNewsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommentaireNewsRepository.php';

        return $container->privates['App\\Repository\\CommentaireNewsRepository'] = new \App\Repository\CommentaireNewsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
