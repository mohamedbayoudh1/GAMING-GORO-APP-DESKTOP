 ...
 */
class getHistoriqueAchatRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistoriqueAchatRepository.php';

        return $container->privates['App\\Repository\\HistoriqueAchatRepository'] = new \App\Repository\HistoriqueAchatRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
