 ...
 */
class getGamerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GamerRepository' shared autowired service.
     *
     * @return \App\Repository\GamerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GamerRepository.php';

        return $container->privates['App\\Repository\\GamerRepository'] = new \App\Repository\GamerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
