 ...
 */
class getRechargeCodeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RechargeCodeRepository' shared autowired service.
     *
     * @return \App\Repository\RechargeCodeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RechargeCodeRepository.php';

        return $container->privates['App\\Repository\\RechargeCodeRepository'] = new \App\Repository\RechargeCodeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
